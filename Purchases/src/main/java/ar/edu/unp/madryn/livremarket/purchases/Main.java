...
public class Main {
    public static void main(String [] args){
        ...
        ServerSnapshotManager.setDataProvider(purchasesDataProvider);
        serverSnapshotManager.setServerStateManager(serverStateManager);

        SnapshotController snapshotController = new SnapshotController(Definitions.PURCHASES_SERVER_NAME);
