...
public class Main {
    public static void main(String[] args) {
        ...
        MessageWorker.setServerID(Definitions.INFRACTIONS_SERVER_NAME);
        ...
        ServerSnapshotManager.setDataProvider(infractionsDataProvider);
        serverSnapshotManager.setServerStateManager(serverStateManager);

        SnapshotController snapshotController = new SnapshotController(Definitions.INFRACTIONS_SERVER_NAME);
