...
public class Definitions {
    public static final String DELIVERIES_SERVER_NAME = "deliveries";
    public static final String INFRACTIONS_SERVER_NAME = "infractions";
    ...
    public static final String MONITOR_SERVER_NAME = "monitor";
